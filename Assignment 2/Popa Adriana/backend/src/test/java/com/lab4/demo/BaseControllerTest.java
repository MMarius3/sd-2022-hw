...
public abstract class BaseControllerTest {
    ...
    protected ResultActions performDeleteWithPathVariable(String path, long variable) throws Exception {
        return mockMvc.perform(delete(path,variable)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON));
    }

    protected ResultActions performGetWithRequest(String path, Object... variable) throws Exception {
        return mockMvc.perform(get(path, variable)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON));
    }
