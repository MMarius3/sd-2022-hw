...
class ReportServiceFactoryTest {
    ...
    void getReportService() {
        ...
        Assertions.assertEquals("I am a CSV reporter", csvReportService.export(List.of("I am a CSV reporter")));

        ReportService pdfReportService = reportServiceFactory.getReportService(PDF);
        Assertions.assertEquals("I am a PDF reporter", pdfReportService.export(List.of("I am a PDF reporter")));
    }
}