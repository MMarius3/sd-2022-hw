...
public class UrlMapping {
    ...
    public static final String ITEMS_CREATE = "/create";
    public static final String ITEMS_ID_PART = "/{id}";
    public static final String SELL_ITEM = "/sell/{id}";
    public static final String DELETE_ITEM = "/delete/{id}";
    ...
    public static final String REPORT = "/{type}";
