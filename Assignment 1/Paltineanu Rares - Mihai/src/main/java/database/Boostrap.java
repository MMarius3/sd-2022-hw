...
import static database.Constants.Rights.EMP_RIGHTS;
import static database.Constants.Rights.ADMIN_RIGHTS;
...
//        dropAll();
    ...
    private static void dropAll() throws SQLException {
        for (String schema : SCHEMAS) {
            ...
            String[] dropStatements = {
                    ...
                    "TRUNCATE `role`;",
                    "DROP TABLE  `action`, `account`, `client`, `user`,  `role`;"
            };
    ...
    private static void bootstrapRights() {
        for (String admin_right : ADMIN_RIGHTS) {
            rightsRolesRepository.addRight(admin_right);
        }

        for(String emp_right: EMP_RIGHTS) {
            rightsRolesRepository.addRight(emp_right);
        }
    }
