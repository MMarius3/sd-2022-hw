...
public class Constants {
  ...
  public static Map<String, List<String>> getRolesRights() {
    ...
    rolesRights.get(ADMINISTRATOR).addAll(Arrays.asList( CREATE_EMPLOYEE, UPDATE_EMPLOYEE, DELETE_EMPLOYEE));

    rolesRights.get(EMPLOYEE).addAll(Arrays.asList(CREATE_CLIENT, DELETE_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT,DELETE_ACCOUNT,UPDATE_ACCOUNT));
  ...
  public static class Rights {
    ...
    public static final String DELETE_EMPLOYEE = "update_employee";
