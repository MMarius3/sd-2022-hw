    ...
    public String getCreateSQLForTable(String table) {
        return switch (table) {
            ...
            case CLIENT_ACCOUNT -> "CREATE TABLE IF NOT EXISTS client_account (" +
                    ...
                    "  UNIQUE KEY id_UNIQUE (id)" +
                    ") ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;";
            case CLIENT_CLIENT_ACCOUNT -> "  CREATE TABLE IF NOT EXISTS client_client_account (" +
                    ...
                    "  INDEX client_account_id_idx (client_account_id ASC)," +
                    "  CONSTRAINT client_id" +
                    "    FOREIGN KEY (client_id)" +
                    "    REFERENCES role (id)" +
                    "    ON DELETE CASCADE" +
                    "    ON UPDATE CASCADE," +
                    "  CONSTRAINT client_account_id" +
